...
var DataJSONLoader = function () {
    THREE.Loader.call( this, false );

    this.withCredentials = false;
};

DataJSONLoader.prototype = Object.create(THREE.Loader.prototype);

DataJSONLoader.prototype.load = function(url, callback) {
    this.onLoadStart();
    this.loadAjaxJSON(this, url, callback);
};

DataJSONLoader.prototype.loadAjaxJSON = function(context, url, callback) {
